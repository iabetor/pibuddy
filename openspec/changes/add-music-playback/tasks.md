...
- [ ] 1.3 新建 `internal/music/netease_test.go` — 用 httptest mock 测试搜索和 URL 获取
...
- [ ] 3.3 新建 `internal/tools/music_test.go` — 测试工具执行逻辑
...
- [ ] 5.2 新建 `scripts/setup-music.sh` — NeteaseCloudMusicApi 部署脚本（可选安装）
